              ...
              <div className="bg-white dark:bg-dark-bg-secondary shadow-lg dark:shadow-card-dark rounded-lg p-8 border border-transparent dark:border-dark-border-primary transition-all duration-300">
                <div className="flex items-center gap-3 mb-6">
                  <div className="relative w-10 h-10 rounded-full flex items-center justify-center group">
                    ...
                    <div className="absolute inset-1 rounded-full bg-accent dark:bg-dark-accent-primary flex items-center justify-center group-hover:bg-accent-hover dark:group-hover:bg-dark-accent-secondary transition-colors duration-300">
