...
export const AboutPage: FC = () => {
  ...
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      image:
        "https://preview.redd.it/i1x05636l4c21.jpg?width=1080&crop=smart&auto=webp&s=36db60e6e87a3f7d713729bec2aa6a08ffde5692",
      social: {
        twitter: "#",
        instagram: "#",
        linkedin: "#",
    ...
    },
    {
      ...
      image:
        "https://tse1.mm.bing.net/th/id/OIP.tOAevqKXmIgq3bg2D9hcrQHaHa?cb=ucfimg2ucfimg=1&rs=1&pid=ImgDetMain&o=7&rm=3",
      social: {
        twitter: "#",
        instagram: "#",
        linkedin: "#",
                ...
                <div className="flex justify-center mb-3 sm:mb-4">
                  <div
                    className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center ${
                      stat.highlighted
                        ? "bg-white/20"
                        : "bg-white-300 group-hover:bg-white/20"
                    }`}
                  >
                    {stat.icon === "shop" && (
                      <ShoppingBagIcon
