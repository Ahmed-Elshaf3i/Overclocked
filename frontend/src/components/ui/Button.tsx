...
export const Button: FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'border-2 border-neutral-300 dark:border-dark-border-primary text-gray-900 dark:text-dark-text-primary hover:border-black dark:hover:border-dark-accent-primary bg-transparent hover:shadow-md dark:hover:shadow-glow-red',
  };
