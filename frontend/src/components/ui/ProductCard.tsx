...
const ProductCardComponent: FC<ProductCardProps> = ({
  ...
  return (
    <div className="group relative bg-neutral-100 dark:bg-dark-bg-secondary rounded overflow-hidden border border-transparent dark:border-dark-border-primary transition-all duration-300 hover:shadow-lg dark:hover:border-dark-border-secondary dark:hover:shadow-glow-subtle">
      ...
      <div className="relative aspect-square overflow-hidden bg-gray-200 dark:bg-dark-bg-elevated">
        {/* Loading Skeleton */}
        {!imageLoaded && (
          <div className="absolute inset-0 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 dark:from-dark-bg-secondary dark:via-dark-bg-elevated dark:to-dark-bg-secondary animate-pulse" />
        )}
        ...
        >
          <span className="font-medium">{t("buttons.addToCart")}</span>
        </button>
      </div>
