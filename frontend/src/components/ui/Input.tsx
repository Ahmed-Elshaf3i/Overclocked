  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        } rounded-lg bg-white dark:bg-dark-bg-secondary text-gray-900 dark:text-dark-text-primary focus:outline-none focus:ring-2 transition-all duration-300 placeholder:text-neutral-400 dark:placeholder:text-dark-text-muted ${className}`}
        {...props}
      />
